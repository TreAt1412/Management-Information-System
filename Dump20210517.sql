...
INSERT INTO `employee` VALUES (6,'Ngọc','KT','KT','012345678','Agribank',9000000,1),(7,'Thắng','KT','KT','01235492','VPBank',9000000,1),(8,'Anh','KT','KT','164246921','Agribank',9000000,1);
...
INSERT INTO `purchasebill` VALUES (3,'757949','2021-05-16 00:00:00','mua hang','Ngọc',1,123,300,'Ngọc');
...
INSERT INTO `purchasedetail` VALUES (3,3,'banh kem',5,20),(4,3,'Điều hòa',2,100);
...
CREATE TABLE `sellingbill` (
  ...
  KEY `overbalanceid_idx` (`overBalanceID`),
  CONSTRAINT `company_selling` FOREIGN KEY (`companyID`) REFERENCES `company` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `overbalanceid` FOREIGN KEY (`overBalanceID`) REFERENCES `overbalance` (`id`)
...
-- Dump completed on 2021-05-17 22:11:19
