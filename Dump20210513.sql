...
CREATE TABLE `purchasebill` (
  ...
  KEY `companyindex_idx` (`companyID`),
  KEY `overbalanceID2_idx` (`overBalanceID`),
  CONSTRAINT `company_purchase` FOREIGN KEY (`companyID`) REFERENCES `company` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `overbalanceID2` FOREIGN KEY (`overBalanceID`) REFERENCES `overbalance` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-05-13 22:30:33
